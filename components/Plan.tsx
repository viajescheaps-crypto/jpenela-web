      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="mt-16 flex flex-col md:flex-row items-center justify-between gap-8 border-t border-white/10 pt-12">
          ...
          <a
            ...
            className="inline-flex items-center gap-3 bg-white text-black font-semibold text-[13px] tracking-wide px-8 py-4 hover:bg-brand-accent transition-colors whitespace-nowrap"
          >
